defmodule ApiServer.ContractManagementTest do
  ...
  describe "contracts" do
    ...
    @valid_attrs %{cname: "some cname", cno: "some cno"}
    ...
    test "create_contract/1 with valid data creates a contract" do
      ...
      assert contract.cname == "some cname"
    ...
    test "update_contract/2 with valid data updates the contract" do
      contract = contract_fixture()
      assert {:ok, contract} = ContractManagement.update_contract(contract, @update_attrs)
      assert %Contract{} = contract
      assert contract.cname == "some updated cname"
