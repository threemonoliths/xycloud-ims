...
var ProjectService = /** @class */ (function () {
    ...
    ProjectService.prototype.listOnePage = function (q) {
        return this.http.get(this.url, { params: Object(_shared_utils_formmat__WEBPACK_IMPORTED_MODULE_4__["formmat"])(q) });
    };
    ProjectService.prototype.listAll = function () {
        return this.http.get(this.url);
    };
    ProjectService.prototype.getById = function (id) {
        return this.http.get(this.url + ("/" + id));
    };
    ProjectService.prototype.add = function (obj) {
        return this.http.post(this.url, obj);
    };
    ProjectService.prototype.update = function (id, obj) {
...
function getTokenOptions() {
    ...
    var jwt = 'Bearer ' + localStorage.getItem('currentToken');
    var _headers = headers.append('Authorization', jwt).append('Content-Type', 'application/json');
...
function setToken() {
    var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_0__["HttpHeaders"]();
    var jwt = 'Bearer ' + localStorage.getItem('currentToken');
    var _headers = headers.append('Authorization', jwt);
    var options = { headers: _headers };
    return options;
}
