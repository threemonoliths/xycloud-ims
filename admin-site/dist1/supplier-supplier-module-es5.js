...
var SupplierFormComponent = /** @class */ (function () {
    function SupplierFormComponent(fb, msg, cdr, router, srv) {
        this.fb = fb;
        this.msg = msg;
        this.cdr = cdr;
        this.router = router;
    ...
    SupplierFormComponent.prototype.submit = function () {
        var _this = this;
        if (!this.srv.isUpdate) {
            console.log("新增客户");
            ...
            this.srv.add(obj).subscribe(function (resp) {
                ...
                _this.router.navigateByUrl('/supplier/page');
            ...
            this.submitting = true;
            var obj = this.formmatFormValue();
            this.srv.update(this.supplier.id, obj).subscribe(function (resp) {
                if (resp['data']) {
                    _this.submitting = false;
                    if (resp['data'])
                        _this.msg.success("\u4FDD\u5B58\u6210\u529F\uFF01");
    ...
    SupplierFormComponent.prototype.setTitle = function () {
        if (this.srv.isUpdate) {
            this.title = '修改供应商';
        }
        else
    ...
    SupplierFormComponent.prototype.initUpdate = function () {
        this.setTitle();
        this.supplier = this.srv.supplier;
    };
    SupplierFormComponent.prototype.formmatFormValue = function () {
        var obj = this.form.value;
        // obj.date = getFormatDateStr(obj.date);
        return { supplier: obj };
    };
    SupplierFormComponent.ctorParameters = function () { return [
...
var SupplierListComponent = /** @class */ (function () {
    function SupplierListComponent(http, msg, modalSrv, cdr, srv, router) {
        this.http = http;
        this.msg = msg;
    ...
    SupplierListComponent.prototype.getData = function () {
        var _this = this;
        this.loading = true;
        this.srv
            .listOnePage(this.q)
    ...
    SupplierListComponent.prototype.add = function (tpl) {
        this.srv.isUpdate = false;
        this.router.navigateByUrl('/supplier/form');
    };
    SupplierListComponent.prototype.modify = function (id) {
        var _this = this;
        this.srv.isUpdate = true;
        this.srv.getById(id).subscribe(function (resp) {
            _this.srv.supplier = resp['data'];
            _this.router.navigateByUrl('/supplier/form');
        });
    };
    SupplierListComponent.prototype.remove = function (item) {
        var _this = this;
    ...
    SupplierListComponent.prototype.reset = function () {
        var _this = this;
        setTimeout(function () { return _this.getData(); });
    };
    SupplierListComponent.prototype.pageChange = function (pi) {
        this.q.pi = pi;
        this.reset();
    };
    SupplierListComponent.prototype.sort = function (sort) {
        this.q.sort_field = sort.key;
        this.q.sort_direction = sort.value;
        this.reset();
    };
    SupplierListComponent.ctorParameters = function () { return [
...
var SupplierService = /** @class */ (function () {
    ...
    SupplierService.prototype.listOnePage = function (q) {
        return this.http.get(this.url, { params: Object(_shared_utils_formmat__WEBPACK_IMPORTED_MODULE_4__["formmat"])(q) });
    };
    SupplierService.prototype.listAll = function () {
        return this.http.get(this.url);
    };
    SupplierService.prototype.getById = function (id) {
        return this.http.get(this.url + ("/" + id));
    };
    SupplierService.prototype.add = function (obj) {
        console.log("新增客户");
        return this.http.post(this.url, obj);
    };
    SupplierService.prototype.update = function (id, obj) {
