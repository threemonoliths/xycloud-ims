...
var AppModule = /** @class */ (function () {
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            providers: tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](LANG_PROVIDES, INTERCEPTOR_PROVIDES, I18NSERVICE_PROVIDES, APPINIT_PROVIDES, [_routes_auth_guard__WEBPACK_IMPORTED_MODULE_20__["AuthGuard"], _message_reminding_service__WEBPACK_IMPORTED_MODULE_21__["MessageRemindingService"]]),
...
var HeaderNotifyComponent = /** @class */ (function () {
    function HeaderNotifyComponent(msg, wsSrv, cdr) {
        this.msg = msg;
        this.wsSrv = wsSrv;
        this.cdr = cdr;
        this.data = [
    ...
    HeaderNotifyComponent.prototype.ngOnInit = function () {
        ...
        this.wsSrv.channel.on("new_msg", function (msg) {
            if (_this.messageList) {
                _this.messageList = _this.messageList.concat(msg['messages']);
            }
            else
                _this.messageList = msg['messages'];
            _this.loadData();
        });
    };
    ...
    HeaderNotifyComponent.prototype.loadData = function () {
        ...
        this.loading = true;
        // setTimeout(() => {
        var msgs = this.getMessagesArray();
    ...
    HeaderNotifyComponent.prototype.getMessagesArray = function () {
        var length = this.messageList.length;
        var src = this.messageList;
        var des = [];
        for (var i in src) {
            var e = { id: src[i]['id'], title: src[i]['body'], datetime: src[i]['datetime'], type: '新的合同', avatar: 'https://gw.alipayobjects.com/zos/rmsportal/ThXAXghbEsBCCSDihZxY.png' };
            des.push(e);
        }
        return des;
    };
    HeaderNotifyComponent.prototype.getMaxDatetime = function (list) {
    ...
    HeaderNotifyComponent.prototype.clear = function (type) {
        ...
        if ((this.messageList) && (this.messageList.length)) {
            var params = { last_datetime: this.getMaxDatetime(this.messageList), token: localStorage.getItem("currentToken") };
...
var HeaderUserComponent = /** @class */ (function () {
    ...
    // }
    HeaderUserComponent.prototype.selfinfo = function () {
        this.router.navigateByUrl('/user/info');
    };
    HeaderUserComponent.prototype.password = function () {
        this.router.navigateByUrl('/user/password');
    };
    HeaderUserComponent.prototype.getUrl = function () {
...
var SidebarComponent = /** @class */ (function () {
    function SidebarComponent(settings, router, tokenService) {
        this.settings = settings;
        this.router = router;
        this.tokenService = tokenService;
        this.avatar = null;
...
var PASSPORT = [_passport_passport_component__WEBPACK_IMPORTED_MODULE_15__["LayoutPassportComponent"]];
...
var MessageRemindingService = /** @class */ (function () {
    function MessageRemindingService() {
        this.setSocket();
    }
    MessageRemindingService.prototype.setSocket = function () {
    ...
    MessageRemindingService.prototype.getChannel = function (channelStr) {
        var channel = this.socket.channel(channelStr, { token: localStorage.getItem("currentToken") });
        channel.join()
            ...
            .receive("timeout", function () { return console.log("Networking issue. Still waiting..."); });
    ...
    return MessageRemindingService;
}());
...
var AuthGuard = /** @class */ (function () {
    function AuthGuard(router, aclSrv, menuSrv) {
        this.router = router;
        this.aclSrv = aclSrv;
...
var UserLoginComponent = /** @class */ (function () {
    function UserLoginComponent(fb, modalSrv, router, settingsService, socialService, reuseTabService, tokenService, startupSrv, http, msg, srv) {
        this.router = router;
    ...
    UserLoginComponent.prototype.submit = function () {
        ...
        this.srv.login({ login: { username: this.userName.value, password: this.password.value } }).subscribe(function (resp) {
            if (resp) {
                _this.tokenService.set({ token: localStorage.getItem("currentToken") });
...
var AuthenticationService = /** @class */ (function () {
    function AuthenticationService(http, aclSrv, menuSrv) {
        this.http = http;
        this.aclSrv = aclSrv;
        this.menuSrv = menuSrv;
    ...
    AuthenticationService.prototype.login = function (value) {
        ...
        return this.http.post(_shared_app_config__WEBPACK_IMPORTED_MODULE_6__["baseUrl"] + "login", value, options)
            ...
            var token = response && response['jwt'];
            var username = response && response['user'] && response['user']['real_name'];
            var position = response && response['user'] && response['user']['position'];
            var avatar = response && response['user'] && response['user']['avatar'];
            var mobile = response && response['user'] && response['user']['mobile'];
            if (!error && token) {
                localStorage.clear();
...
var routes = [
    {
        ...
        children: [
            ...
            // project
            { path: 'project', loadChildren: function () { return Promise.all(/*! import() | project-project-module */[__webpack_require__.e("common"), __webpack_require__.e("project-project-module")]).then(__webpack_require__.bind(null, /*! ./project/project.module */ "./src/app/routes/project/project.module.ts")).then(function (m) { return m.ProjectModule; }); } },
            // contract
            { path: 'contract', loadChildren: function () { return Promise.all(/*! import() | contract-contract-module */[__webpack_require__.e("common"), __webpack_require__.e("contract-contract-module")]).then(__webpack_require__.bind(null, /*! ./contract/contract.module */ "./src/app/routes/contract/contract.module.ts")).then(function (m) { return m.ContractModule; }); } },
            { path: 'purchase_contract', loadChildren: function () { return Promise.all(/*! import() | purchase_contract-purchase_contract-module */[__webpack_require__.e("common"), __webpack_require__.e("purchase_contract-purchase_contract-module")]).then(__webpack_require__.bind(null, /*! ./purchase_contract/purchase_contract.module */ "./src/app/routes/purchase_contract/purchase_contract.module.ts")).then(function (m) { return m.PurchaseContractModule; }); } },
            // user
            { path: 'user', loadChildren: function () { return Promise.all(/*! import() | user-user-module */[__webpack_require__.e("common"), __webpack_require__.e("user-user-module")]).then(__webpack_require__.bind(null, /*! ./user/user.module */ "./src/app/routes/user/user.module.ts")).then(function (m) { return m.UserModule; }); } },
            // user self info
            { path: 'user/info', loadChildren: function () { return Promise.all(/*! import() | userinfo-user-info-module */[__webpack_require__.e("common"), __webpack_require__.e("userinfo-user-info-module")]).then(__webpack_require__.bind(null, /*! ./userinfo/user-info.module */ "./src/app/routes/userinfo/user-info.module.ts")).then(function (m) { return m.UserInfoModule; }); } },
            // user password
            { path: 'user/password', loadChildren: function () { return __webpack_require__.e(/*! import() | userpassword-user-password-module */ "userpassword-user-password-module").then(__webpack_require__.bind(null, /*! ./userpassword/user-password.module */ "./src/app/routes/userpassword/user-password.module.ts")).then(function (m) { return m.UserPasswordModule; }); } },
            // tmpl
            { path: 'tmpl', loadChildren: function () { return Promise.all(/*! import() | tmpl-tmpl-module */[__webpack_require__.e("common"), __webpack_require__.e("tmpl-tmpl-module")]).then(__webpack_require__.bind(null, /*! ./tmpl/tmpl.module */ "./src/app/routes/tmpl/tmpl.module.ts")).then(function (m) { return m.TmplModule; }); } },
            //client
            { path: 'client', loadChildren: function () { return Promise.all(/*! import() | client-client-module */[__webpack_require__.e("common"), __webpack_require__.e("client-client-module")]).then(__webpack_require__.bind(null, /*! ./client/client.module */ "./src/app/routes/client/client.module.ts")).then(function (m) { return m.ClientModule; }); } },
            //supplier
            { path: 'supplier', loadChildren: function () { return Promise.all(/*! import() | supplier-supplier-module */[__webpack_require__.e("common"), __webpack_require__.e("supplier-supplier-module")]).then(__webpack_require__.bind(null, /*! ./supplier/supplier.module */ "./src/app/routes/supplier/supplier.module.ts")).then(function (m) { return m.SupplierModule; }); } },
        ],
    },
    // 全屏布局
    // passport
