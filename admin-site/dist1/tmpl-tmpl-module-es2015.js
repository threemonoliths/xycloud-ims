...
let TmplFormComponent = class TmplFormComponent {
...
TmplFormComponent.ctorParameters = () => [
...
let TmplListComponent = class TmplListComponent {
...
let TmplRoutingModule = class TmplRoutingModule {
};
...
let TmplComponent = class TmplComponent {
    constructor() { }
};
...
let TmplModule = class TmplModule {
};
...
let TmplService = class TmplService {
    constructor(http) {
        this.http = http;
...
//# sourceMappingURL=tmpl-tmpl-module-es2015.js.map