...
var ContractFormComponent = /** @class */ (function () {
    // channel: any;
    function ContractFormComponent(fb, msg, cdr, router, srv, projectService, wsSrv) {
        this.fb = fb;
        this.msg = msg;
        this.cdr = cdr;
        this.router = router;
    ...
    ContractFormComponent.prototype.ngOnInit = function () {
        ...
        if ((op == 'update') || (op == 'audit' || (op == 'show'))) {
            this.contract.contract_details ? this.contract.contract_details.forEach(function (i) {
                var field = _this.createDetail();
                field.patchValue(i);
                _this.contract_details.push(field);
            }) : console.log("this contract has no contract_details.");
        }
    };
    //新增明细
    ContractFormComponent.prototype.createDetail = function () {
    ...
    Object.defineProperty(ContractFormComponent.prototype, "cno", {
        //#region get form fields
        get: function () { return this.form.controls.cno; },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(ContractFormComponent.prototype, "cname", {
        get: function () { return this.form.controls.cname; },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(ContractFormComponent.prototype, "project_id", {
        get: function () { return this.form.controls.project_id; },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(ContractFormComponent.prototype, "party_a", {
        get: function () { return this.form.controls.party_a; },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(ContractFormComponent.prototype, "party_b", {
        get: function () { return this.form.controls.party_b; },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(ContractFormComponent.prototype, "sign_date", {
        get: function () { return this.form.controls.sign_date; },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(ContractFormComponent.prototype, "expiry_date", {
        get: function () { return this.form.controls.expiry_date; },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(ContractFormComponent.prototype, "amount", {
        get: function () { return this.form.controls.amount; },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(ContractFormComponent.prototype, "comments", {
        get: function () { return this.form.controls.comments; },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(ContractFormComponent.prototype, "contract_details", {
        get: function () { return this.form.controls.contract_details; },
        enumerable: true,
        configurable: true
    });
    //#endregion
    ContractFormComponent.prototype.add = function () {
        this.contract_details.push(this.createDetail());
        this.edit(this.contract_details.length - 1);
    };
    ContractFormComponent.prototype.del = function (index) {
        this.contract_details.removeAt(index);
    };
    ContractFormComponent.prototype.edit = function (index) {
        if (this.editIndex !== -1 && this.editObj) {
            this.contract_details.at(this.editIndex).patchValue(this.editObj);
        }
        this.editObj = tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, this.contract_details.at(index).value);
        this.editIndex = index;
    };
    ContractFormComponent.prototype.save = function (index) {
        this.contract_details.at(index).markAsDirty();
        if (this.contract_details.at(index).invalid)
            return;
        this.editIndex = -1;
    };
    ContractFormComponent.prototype.cancel = function (index) {
    ...
    //提交表
    ContractFormComponent.prototype.submit = function () {
        var _this = this;
        console.log('表格提交');
        ...
        if (this.form.valid) {
            ...
            if (op == 'create') {
                ...
                this.srv.add(obj).subscribe(function (resp) {
                    ...
                    _this.router.navigateByUrl('/contract/page');
            ...
            if (op == 'update') {
                this.submitting = true;
                var obj = this.formmatFormValue();
                this.srv.update(this.contract.id, obj).subscribe(function (resp) {
                    if (resp['data']) {
                        _this.submitting = false;
                        if (resp['data'])
                            _this.msg.success("\u4FDD\u5B58\u6210\u529F\uFF01");
    ...
    ContractFormComponent.prototype.initShow = function () {
        this.title = '查看合同';
        this.editable = false;
        //this.contract = this.contractForPurchaseService.updateContract;
        this.contract = this.srv.contract;
    ...
    ContractFormComponent.prototype.formmatFormValue = function () {
        var obj = this.form.value;
        obj.sign_date = Object(_shared_utils_datehandler__WEBPACK_IMPORTED_MODULE_5__["getFormatDateStr"])(obj.sign_date);
        return { contract: obj };
    };
    ContractFormComponent.prototype.getProjectData = function () {
        var _this = this;
    ...
    ContractFormComponent.ctorParameters = function () { return [
...
var ContractListComponent = /** @class */ (function () {
    function ContractListComponent(http, msg, modalSrv, cdr, srv, router) {
        this.http = http;
        this.msg = msg;
    ...
    ContractListComponent.prototype.getData = function () {
        var _this = this;
        this.loading = true;
        this.srv
            .listOnePage(this.q)
    ...
    // }
    ContractListComponent.prototype.add = function (tpl) {
        //this.srv.isUpdate = false;
        this.srv.formOperation = 'create';
        this.router.navigateByUrl('/contract/form');
    };
    ContractListComponent.prototype.modify = function (id) {
        var _this = this;
        //this.srv.isUpdate = true;
        this.srv.formOperation = 'update';
        this.srv.getById(id).subscribe(function (resp) {
            _this.srv.contract = resp['data'];
            _this.srv.contract.contract_details = resp['data'].details;
            console.log(_this.srv.contract);
            _this.router.navigateByUrl('/contract/form');
        });
    };
    ContractListComponent.prototype.remove = function (item) {
        var _this = this;
    ...
    ContractListComponent.prototype.pageChange = function (pi) {
        this.q.pi = pi;
        this.reset();
    };
    ContractListComponent.prototype.sort = function (sort) {
...
//# sourceMappingURL=contract-contract-module-es5.js.map