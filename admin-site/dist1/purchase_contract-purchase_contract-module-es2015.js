...
let PurchaseContractFormComponent = class PurchaseContractFormComponent {
    ...
    get purchase_contract_details() { return this.form.controls.purchase_contract_details; }
    //#endregion
    add() {
    ...
    edit(index) {
        ...
        this.editObj = Object.assign({}, this.purchase_contract_details.at(index).value);
...
PurchaseContractFormComponent.ctorParameters = () => [
...
PurchaseContractListComponent.ctorParameters = () => [
...
let PurchaseContractRoutingModule = class PurchaseContractRoutingModule {
};
...
let PurchaseContractComponent = class PurchaseContractComponent {
    constructor() { }
};
...
let PurchaseContractModule = class PurchaseContractModule {
};
...
//# sourceMappingURL=purchase_contract-purchase_contract-module-es2015.js.map